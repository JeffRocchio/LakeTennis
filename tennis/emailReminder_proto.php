<?php
/*
	Script intended to be executed by CRON to automatically
	send out the weekly Tuesday email reminder.
	
	
	10/19/2011 Version 0.1 --
...
$emBody;
$emSubject = "TENNIS - Thurs and Saturday (no reply)";
$emTo = array();
...
//----OUTPUT PAGE HEADER------------------------------------------------------->
$tbar = "Tennis Reminder Email Auto Send";
$pgL1 = "Reminder Email Auto Send";
$pgL2 = "";
$pgL3 = "Sending Weekly Reminder Emails";
...
$emBody = "";
$freeText[0] = "** Please do not reply to this email as this is ";
$freeText[1] = "** an automated message.";
$freeText[2] = "";
...
foreach ($recID as $curEvtID)
	...
	$emBody .= "   * {$dispEvtName}, {$tmp} at {$dispVenue}{$emCRLF}{$emCRLF}";
	$out .= "&nbsp;&nbsp;&nbsp;*&nbsp;{$dispEvtName}, {$tmp} at {$dispVenue}<BR /><BR />{$CRLF}";
	}
unset($freeText);	
$freeText[0] = "";
$freeText[1] = "Please self-declare your availability:";
$freeText[2] = "";
$freeText[3] = "To self-declare your availability click on the Full RSVP Grid link or the Mobile Phone View link below. Then at the bottom of the page login (if you don't know your ID or password try using your last name as both ID and Password - all small letters, no caps). When logged in you'll see an Edit link in the cells by your name. Click that Edit link and you'll be able to self-declare your availability over the next month.";
foreach ($freeText as $textLine)
	{
	$out .= $textLine . "<BR />";
	$emBody .= "{$textLine}{$emCRLF}";
...
$emTo[0] = "rocchio@rocketmail.com, jroc@activeage.com";
