<?php
/*
	This script allows you to edit all RSVP records for a
	given person for a given series.
	
	12/31/2007: Version 1.0.
...
//----BUILD PAGE DATA-ENTRY-------------------------------------------------->
	...
	$rtnpg = "/tennis/mobile/mlistSeriesRoster.php?ID={$seriesID}";
	...
	echo "<form method='post' action='meditRSVPPrsn.php?SID={$seriesID}&POST=T'>{$CRLF}";
